<template>
  <div class="textBox">
    ...
    <textarea v-if="type == 'textarea'" v-model="valueField" :name="name" :maxlength="maxlength" :placeholder="placeholder" @click="echoClick" @focus="echoFocus" @blur="echoBlur"></textarea>
    <input v-else ref="input" :style="inputStyle" v-model="valueField" :type="type" :name="name" :maxlength="maxlength" :placeholder="placeholder" :autocomplete="autocomplete" :title="title" @click="echoClick" @focus="echoFocus" @blur="echoBlur" />
