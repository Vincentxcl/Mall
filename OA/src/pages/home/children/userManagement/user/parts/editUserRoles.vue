<template>
  <dialog-window v-show="isShowField" class="editUserRoles" @iconClick="close">
    <template slot="title">配置用户"{{selectedUser.account }}"的角色</template>
...
div.editUserRoles div.grid input {
  margin-right: 5px;
}
